        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nom_Admin = table.Column<string>(nullable: true),
                    Prenom_Admin = table.Column<string>(nullable: true),
                    CIN_Admin = table.Column<string>(nullable: true),
                    Email_Admin = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_Prof = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nom_Prof = table.Column<string>(nullable: true),
                    Prenom_Prof = table.Column<string>(nullable: true),
                    CIN_Prof = table.Column<string>(nullable: true),
                    Email_Prof = table.Column<string>(nullable: true),
                    Mdp = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_Salle = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nom_Salle = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nom_Etd = table.Column<string>(nullable: true),
                    Prenom_Etd = table.Column<string>(nullable: true),
                    CIN_Etd = table.Column<string>(nullable: true),
                    Id_Filiere = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_Matiere = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nom_Matiere = table.Column<string>(nullable: true),
                    Id_Prof = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_matieres_professeurs_Id_Prof",
                        column: x => x.Id_Prof,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_Presence = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_presences", x => x.Id_Presence);
                    table.ForeignKey(
                        name: "FK_presences_salles_Id_Salle",
                        column: x => x.Id_Salle,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id_Filiere = table.Column<int>(nullable: false),
                    Id_Salle = table.Column<int>(nullable: false),
                    Heure_D = table.Column<string>(nullable: true),
                    Heure_F = table.Column<string>(nullable: true),
                    Id_Matiere = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_seances_filieres_Id_Filiere",
                        column: x => x.Id_Filiere,
                        principalTable: "filieres",
                        principalColumn: "Id_Filiere",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_matieres_Id_Prof",
                table: "matieres",
                column: "Id_Prof");

            migrationBuilder.CreateIndex(
                name: "IX_presences_Id_Salle",
                table: "presences",
                column: "Id_Salle");

            migrationBuilder.CreateIndex(
                name: "IX_seances_Id_Filiere",
                table: "seances",
                column: "Id_Filiere");
